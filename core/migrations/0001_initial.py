# Generated by Django 2.1.4 on 2018-12-06 17:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='shaka.png', upload_to=core.models.MemberModels.get_profile_pic_upload_location, verbose_name='Profile Picture')),
        ...
        migrations.AddField(
            model_name='gear',
            name='image',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.AlreadyUploadedImage'),
        ),
        migrations.AddField(
