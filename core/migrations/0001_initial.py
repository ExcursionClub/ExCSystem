# Generated by Django 2.1.7 on 2019-03-24 17:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "primary_key",
                    core.models.fields.PrimaryKeyField.PrimaryKeyField(
                        default=core.models.fields.PrimaryKeyField.make_id,
                        primary_key=True,
                        serialize=False,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        default="shaka.webp",
                        upload_to=core.models.FileModels.get_upload_path,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "requirements",
                    models.TextField(verbose_name="Minimum Certification Requirements"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        help_text="Must use this format to define choices!\nEach choice must be on it's own line, and consist of a short name (used internally), and a description (seen by the user). Name description pairs must be separated by a semicolon, and no semicolons are allowed in either the name or the description",
                        max_length=1000,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "exc_email",
                    models.EmailField(
                        max_length=255, unique=True, verbose_name="Official ExC Email"
                    ),
                ),
                (
                    "title",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to=settings.AUTH_USER_MODEL,
                        validators=[core.models.TransactionModels.validate_auth],
                    ),
                ),
                (
                    "gear",
                    models.ForeignKey(
                        ...
                        to="core.Gear",
                        validators=[core.models.TransactionModels.validate_available],
                    ),
                ),
                (
                    "member",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="core.GearType"
            ),
        ),
        migrations.AddField(
            model_name="gear",
